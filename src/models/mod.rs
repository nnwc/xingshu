...
pub struct UpdateTask {
    ...
    pub notify_enabled: Option<bool>,
    pub notify_channel: Option<Option<String>>,
    pub notify_events: Option<Option<Vec<String>>>,
    pub notify_attach_log: Option<bool>,
    pub notify_log_limit: Option<Option<i64>>,
    pub notify_log_mode: Option<Option<String>>,
    pub env: Option<Option<String>>,
    pub pre_command: Option<Option<String>>,
    pub post_command: Option<Option<String>>,
    pub group_id: Option<Option<i64>>,
    pub working_dir: Option<Option<String>>,
    pub account_run_mode: Option<Option<String>>,
    pub account_env_key: Option<Option<String>>,
    pub account_split_delimiter: Option<Option<String>>,
    pub account_concurrency: Option<Option<i64>>,
    pub schedule_mode: Option<Option<String>>,
    pub schedule_config: Option<Option<serde_json::Value>>,
    pub use_microwarp: Option<bool>,
    pub microwarp_switch_ip_on_run: Option<bool>,
}
